<template>
  <div>
        ...
        <router-link to="#" slot="right">
          ...
          <yd-popup v-model="show1" position="center" width="80%"style="radius:5px;" >
              <div style="background-color:#fff;height:100px;">
                  <yd-datetime type="date" style="height: 50px;line-height: 50px;text-align: center;width:49%;display:inline-block;font-size:20px;color:#000;" v-model="startTime2"></yd-datetime>~
                  <yd-datetime type="date" style="height: 50px;line-height: 50px;text-align: center;width:49%;display:inline-block;font-size:20px;color:#000;" v-model="endTime2"></yd-datetime>
                  <p style="text-align: center;padding: 10px 0;">
                    <yd-button style="width:50px;height:30px;font-size:14px;margin-right:50px;" type="hollow" @click.native="getAnother">确定</yd-button>
                    <yd-button style="width:50px;height:30px;font-size:14px;margin-left:50px;" type="hollow" @click.native="show1 = false">取消</yd-button>
                  </p>
              </div>
          </yd-popup>
        </router-link>
    ...
    <div id="tables">
      <div id="datepick1">
        <yd-datetime type="date" style="height: 20px;line-height: 20px;text-align: center;width:40%;display:inline-block;font-size:12px;" :callback="refresh1" v-model="startTime"></yd-datetime>~
        <yd-datetime type="date" style="height: 20px;line-height: 20px;text-align: center;width:40%;display:inline-block;font-size:12px;" :callback="refresh1" v-model="endTime"></yd-datetime>
      </div>
      <div v-if="picked" id="datepick2" >
        <yd-datetime type="date" style="height: 20px;line-height: 20px;text-align: center;width:40%;display:inline-block;font-size:12px;" :callback="getAnother" v-model="startTime2"></yd-datetime>~
      <yd-datetime type="date" style="height: 20px;line-height: 20px;text-align: center;width:40%;display:inline-block;font-size:12px;" :callback="getAnother" v-model="endTime2"></yd-datetime>
      </div>
      <div id="tablewarpOut" >
            ...
            <div class="listwarp" v-for="subitem in item.option.series.data" v-if="subitem.value > 0">
              <router-link :to="{path:'/showDetail', query:{merchtp:subitem.merchTp}}">
                <div class="listitem" >
                  ...
                  <div class="listbar">
                    <yd-progressbar type="line" :progress="subitem.precent/100" trail-width="4" trail-color="#FE5D51"></yd-progressbar> 
                  </div>
                </div>
